...
const BabysittersPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchBabysitters = async () => {
            try {
                const babysittersCollectionRef = collection(
                    FIREBASE_DB,
                    "babysitters"
                );
                const babysitterSnapshot = await getDocs(
                    babysittersCollectionRef
                );
        ...
        return (
            <>
                        ...
                        {filters.babysittingPlace.map((option, index) => (
                            <Chip
                                ...
                                onDelete={() =>
                                    handleFilterChange(
                                        "babysittingPlace",
                                        filters.babysittingPlace.filter(
                                            (item) => item !== option
                                        )
                                    )
                                }
                    ...
                    >
                        ...
                        <DialogActions>
                            {[
                                ...
                                (
                                    { label, onClick, variant, style, hover },
                                    index
                                ) => (
                                    <Button
                                        key={index}
                ...
                <ApplicationSectionWrapper>
                    ...
                    >
                        Need a Babysitter? Let us help you find the perfect
                        match!
                    </Typography>
                    <Typography
                        variant="subtitle1"
                    ...
                    >
                        Create an application with your needs and connect with
                        qualified babysitters in your area.
                    </Typography>
                    <Button
                        variant="contained"
                        style={{
                ...
                <Container style={{ margin: "50px auto" }}>
                    ...
                    <Box
                        ...
                        alignItems="center"
                    >
                        {["Search", "Contact", "Childcare Services"].map(
                            (step, index) => (
                                <Box
                                    key={index}
                                    style={{
                                    ...
                                    <Box>
                                        ...
                                        {index === 0 && (
                                            ...
                                            >
                                                ...
                                                and check recommended profiles.
                                            </Typography>
                                        )}
                                        {index === 1 && (
                                            <Typography
                                            ...
                                            >
                                                Send messages, rate members, and
                                                schedule a meet-up.
                                            </Typography>
                                        )}
                                        {index === 2 && (
                                            ...
                                            >
                                                Book childcare, make payments or
